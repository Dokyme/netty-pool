...
public class ConnectionPools {
    ...
    public static ConnectionPool newSingleConnectionPool(Bootstrap sample) {
        return new AbstractConnectionPool(1, 1, 0, sample);
    }

    public static ConnectionPool newCachedConnectionPool(Bootstrap sample) {
        return new AbstractConnectionPool(DEFAULT_CORE_SIZE, DEFAULT_MAX_SIZE, DEFAULT_KEEPALIVE, sample);
    }

    public static ConnectionPool newFixedConnectionPool(int num, Bootstrap sample) {
